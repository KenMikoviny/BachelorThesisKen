...
def get_dataloaders():
    ...
    valid_samples = [loader.resolve_sample("/1hop/*:atmost1000"), loader.resolve_sample("/1hop-2i/*:atmost1000"), loader.resolve_sample("/2hop/*:atmost1000"), 
                    loader.resolve_sample("/2i/*:atmost1000"), loader.resolve_sample("/2i-1hop/*:atmost1000"),
                    loader.resolve_sample("/3hop/*:atmost1000"), loader.resolve_sample("/3i/*:atmost1000"),
                    ]
    test_samples = [loader.resolve_sample("/1hop/*:atmost1000"), loader.resolve_sample("/1hop-2i/*:atmost1000"), loader.resolve_sample("/2hop/*:atmost1000"), 
                    loader.resolve_sample("/2i/*:atmost1000"), loader.resolve_sample("/2i-1hop/*:atmost1000"),
                    loader.resolve_sample("/3hop/*:atmost1000"), loader.resolve_sample("/3i/*:atmost1000"),
                    ]
